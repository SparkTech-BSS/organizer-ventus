    ...
    <>
      ...
      >
        <Container className={cn(" relative flex justify-between items-center")}>
          ...
          <button className="hidden w-[136px] h-[38px] px-4 py-[12.50px] bg-red-600 hover:bg-red-800 transition-all rounded-[66px] justify-center items-center gap-2.5 md:flex">
