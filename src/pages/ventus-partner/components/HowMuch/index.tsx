...
export function HowMuch() {
  ...
  return (
    <>
      <Container className={cn("sm:py-20 pt-20 gap-[120px] items-start self-stretch flex lg:pb-20")}>
        <div className="flex flex-col items-start gap-20">
          <div className="w-full flex flex-col gap-8 items-start self-stretch">
            <div className="flex flex-col items-start gap-4 self-stretch">
              <div className="flex flex-col items-start self-stretch">
                <h3 className="text-purple-500 text-[40px] font-semibold font-sans">Sendo Ventus Partner.</h3>
                <p className="text-white text-[40px] font-semibold font-sans">Você pode ganhar </p>
              </div>
            </div>
        ...
        <Image src={personImg}
          alt=""
          quality={100}
          className="max-w-[464px] rounded-[20px] "
        />
